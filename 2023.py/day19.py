...
def find_accept_ranges(workflows: dict[str, list], workflow: list, accept_ranges: set[tuple[range]]):
    if workflow == 'A':
    ...
    for accept_range in accept_ranges:
        ...
        for step in workflow[:-1]:
            ...
            workflow_ranges.update(find_accept_ranges(workflows, next_workflow, make_set(accept_range)))
